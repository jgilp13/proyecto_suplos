...
$cod_info = $_GET['cod_info'];
$listaMoneda = ManejoMoneda::getList();
$listaActividad = ManejoActividad::getList();
$info_info_basica = ManejoInfoBasica::consultInfoBascia($cod_info);
$cronograma = ManejoCronograma::consultCronograma($info_info_basica->getCod_cronograma());
?>
                ...
                <div class="signup-card card-block ">
                    <form action="ModuloOferta/creaProceso.php" method="post" id="formCreaProceso"
                        ...
                        <div class="row m-b-20">
                            <div class="col-md-12">
                                <h1 class="text-center txt-primary">Editar la oferta de procesos</h1>
                            </div>
                        </div>
                        <div class="auth-box">
                            <div class="row m-b-20">
                                <div class="col-md-12">
                                    <h3 class="text-center txt-primary">Informacion Básica</h3>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        <input type="text" id="objeto" name="objeto" class="form-control"
                                            placeholder="Objeto" required value="<?php echo $info_info_basica->getObjeto()?>">
                                        <span class="md-line"></span>

                                    </div>
                                    <h5>Descripcion / Alcance</h5>
                                    <div class="input-group">
                                        <textarea type="text-area" id="descripcion" name="descripcion"
                                            class="form-control" placeholder="Descripcion" required> <?php echo $info_info_basica->getDescripcion()?> </textarea>
                                        <span class="md-line"></span>
                                    </div>
    ...
    $i
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="number" id="precio" name="precio" class="form-control"
                                                        placeholder="Digita la cantidad de dinero" value="<?php echo $info_info_basica->getNum_presupuesto()?>" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    $i
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" id="fecha_inicio" name="fecha_inicio" class="form-control" value="<?php echo $cronograma->getFecha_inicio()?>"
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <div class="input-group">
                                        <input type="time" id="hora_inicio" name="hora_inicio" class="form-control" value="<?php echo $cronograma->getHora_inicio()?>"
                                            required>
                                        <span class="md-line"></span>
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" id="fecha_cierre" name="fecha_cierre" class="form-control" value="<?php echo $cronograma->getFecha_cierre()?>"
                                            placeholder="YYYY-MM-DD" required>
                                        <span class="md-line"></span>
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <div class="input-group">
                                        <input type="time" id="hora_cierre" name="hora_cierre" class="form-control" value="<?php echo $cronograma->getHora_cierre()?>"
                                            required>
                                        <span class="md-line"></span>
                            ...
                            <div class="row m-t-40 d-flex justify-content-center">
                                <div class="col-md-2">
                                    <input type="submit" name="creaProceso" id="creaProceso"
                                        ...
                                        class="btn btn-md btn-block waves-effect text-center m-b-20" value="Guardar" />
                                </div>
                            </div>
                            <hr />
                        </div>
